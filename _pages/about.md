...
I believe the best ML systems are built by people who understand both the algorithms and the infrastructure. That's where I thrive.

**Certification**
AWS Certified Machine Learning – Associate | Experienced in architecting ML solutions on AWS infrastructure

**Tech I Work With**
ML & AI: PyTorch, TensorFlow, Transformers, Diffusion Models, CLIP, LoRA, RAG
MLOps: MLflow, Kubeflow, Airflow, Docker, Kubernetes, CI/CD
Data: Spark, Hive, Snowflake, AWS EMR, Kafka
Vector/Semantic Search: Pinecone, FAISS, Cohere
Cloud & APIs: AWS, FastAPI, REST, microservices
